...
let FollowersRepository = /** @class */ (() => {
    let FollowersRepository = class FollowersRepository extends repository_1.DefaultCrudRepository {
        constructor(dataSource) {
            super(models_1.Followers, dataSource);
        }
    };
    FollowersRepository = tslib_1.__decorate([
